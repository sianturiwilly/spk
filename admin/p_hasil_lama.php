...
<?php
$no=0;
$daftar_3='<td width="40">NO</td><td width="100">NO. REGISTRASI</td><td>NAMA</td><td width="100">NILAI</td><td width="100">RANK</td>';
...
for($i=0;$i<count($alternatif);$i++){
	...
	if ($hasil_akhir[$alternatif[$i][0]][1] <=25){
		$y="insert into hasil(layak,no,nama,nilai,rangking) values ('Layak','".$no."','".$alternatif[$i][2]."','".$hasil_akhir[$alternatif[$i][0]][0]."','".$hasil_akhir[$alternatif[$i][0]][1]."') ";
	}
	
	else{
		$y="insert into hasil(layak,no,nama,nilai,rangking) values ('Tidak Layak','".$no."','".$alternatif[$i][2]."','".$hasil_akhir[$alternatif[$i][0]][0]."','".$hasil_akhir[$alternatif[$i][0]][1]."') ";
	}		
